...
void Graph<T>::calcPrice(string srstn,string dstn)
{
    ...
    cout<<endl<<"\t\t\t";
    cout<<"--> Fare is: Rs. "<<arr[a-1][b-1] << endl << endl << endl;
}
...
int main(){
    ...
    cout<<"\t\t"<<"|  \\/  | ___| |_ _ __ ___   \t |  \\/  | ___| |_ ___"<<endl;
    cout<<"\t\t"<<"| |\\/| |/ _ \\ __| '__/ _ \\  \t | |\\/| | |_ | __/ _ \\"<<endl;
    cout<<"\t\t"<<"| |  | |  __/ |_| | | (_) |    \t | |  | |--| | |_| __/" <<endl;
    cout<<"\t\t"<<"|_|  |_|\\___|\\__|_|  \\___/   \t |_|  |_|\\___|\\__\\___|"<<endl;
    ...
    if(res==false)
    {
      cout << "Error Occured !! Invalid Station Entered";
      system("cls");
      return 0;
    }
